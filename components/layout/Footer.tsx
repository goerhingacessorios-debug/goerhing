...
export default function Footer() {
  return (
    <footer className="bg-brand-black text-neutral-400">
      <div className="container-px grid grid-cols-2 gap-10 py-14 md:grid-cols-4 lg:grid-cols-5">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            <li>
              ...
              >
                <FaWhatsapp size={15} className="text-brand-orange" />
            ...
            <li className="flex items-start gap-2">
              <MapPin size={15} className="mt-0.5 text-brand-orange" />
              {SITE.address}
            </li>
          </ul>
        </div>
